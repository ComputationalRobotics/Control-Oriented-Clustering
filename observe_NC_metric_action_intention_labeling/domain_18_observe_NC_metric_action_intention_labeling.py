...
# other files
from utils_action_intention_labeling import *
...
def main():
    ...
    plt.savefig(f"NC1_action_intention_label.png")
    ...
    plt.savefig(f"NC2_norm_action_intention_label.png")
    ...
    plt.savefig(f"NC2_angle_action_intention_label.png")
